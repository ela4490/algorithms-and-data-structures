...
class Solution {
    ...
    public List<List<Integer>> combinationSum(int[] candidates, int target) {
        ...
        sumHelper(candidates, target, new ArrayList<>(), 0, 0);
        return result;
    }
    
    private void sumHelper(int[] candidates, int target, List<Integer> subList, int currentSum, int index) {
        ...
        for(int i = index; i < candidates.length; i++) {
            ...
            sumHelper(candidates, target, subList, currentSum + candidates[i], i);
